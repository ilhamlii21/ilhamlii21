...
def svg_overwrite(filename, age_data, commit_data, star_data, repo_data, contrib_data, follower_data, loc_data):
    ...
    root = tree.getroot()
    justify_format(root, 'age_data', age_data, 54)
...
if __name__ == '__main__':
    ...
    # Ganti tanggal lahir Anda di sini (Tahun, Bulan, Tanggal)
    age_data, age_time = perf_counter(daily_readme, datetime.datetime(2005, 5, 21))
    ...
    # several repositories that Andrew contributed to have since been deleted.
    # archived data is only applied for Andrew's GitHub ID. For ilhamlii21, it will be skipped.
